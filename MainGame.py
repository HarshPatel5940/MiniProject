...
label_widget = tkinter.Label(
    root,
    text="Move Front= W Key \n Move Back= S Key \n Move Left= A Key\n Move Right= D key \n\n Each time the snake eats the food it grows longer \n\n If snake's head touches its body, tail or the walls the game ends and you lose",
    fg="White",
    width=61,
    height=23,
    bg="Black",
...
button_widget = tkinter.Button(
    root, text="PROCEED", width=20, height=3, bd="5", command=run
)
